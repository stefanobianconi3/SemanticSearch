...
function (_Formula) {
  ...
  function IndexedFormula(features) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(IndexedFormula).call(this, undefined, undefined, undefined, undefined, opts));
  ...
  (0, _createClass2.default)(IndexedFormula, [{
    ...
    value: function add(subj, pred, obj, why) {
      ...
      if (this.dataCallbacks) {
        ...
        try {
          for (var _iterator = this.dataCallbacks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
