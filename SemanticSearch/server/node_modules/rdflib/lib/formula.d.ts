...
import { BlankNode, RdfJsDataFactory, Quad_Graph, Quad_Object, Quad_Predicate, Quad, Quad_Subject, Term, NamedNode } from './tf-types';
...
export default class Formula extends Node {
  ...
  */
    constructor(statements?: Quad[], constraints?: ReadonlyArray<any>, initBindings?: ReadonlyArray<any>, optional?: ReadonlyArray<any>, opts?: FormulaOpts);
     ...
     */
    add(subject: Quad_Subject, predicate: Quad_Predicate, object: Quad_Object, graph?: Quad_Graph): number;
    ...
    */
    any(s?: Quad_Subject | null, p?: Quad_Predicate | null, o?: Quad_Object | null, g?: Quad_Graph | null): Term | null;
    /**
     ...
     */
    anyStatementMatching(s?: Quad_Subject | null, p?: Quad_Predicate | null, o?: Quad_Object | null, g?: Quad_Graph | null): Quad | undefined;
    /**
     ...
     */
    statementsMatching<JustOne extends boolean = false>(s?: Quad_Subject | null, p?: Quad_Predicate | null, o?: Quad_Object | null, g?: Quad_Graph | null, justOne?: boolean): Quad[];
    /**
    ...
    * @returns {Array<Node>} - An array of nodes which match the wildcard position
    */
    each(s?: Quad_Subject | null, p?: Quad_Predicate | null, o?: Quad_Object | null, g?: Quad_Graph | null): Term[];
    /**
     ...
     */
    connectedStatements(subject: Quad_Subject, doc: Quad_Graph, excludePredicateURIs?: ReadonlyArray<string>): Quad[];
    /**
     ...
     * @param g - The graph that contains the statement
     */
    the(s?: Quad_Subject | null, p?: Quad_Predicate | null, o?: Quad_Object | null, g?: Quad_Graph | null): Term | null | undefined;
    /**
     * RDFS Inference
